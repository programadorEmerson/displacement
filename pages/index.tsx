...
const Client: NextPage = () => {
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      headerAlign: 'center',
      renderCell: ({ row }) => {
        const { logradouro, numero, bairro } = row as ClientContext;
        return (
          <span>
    ...
    },
    {
      ...
      headerAlign: 'center',
      renderCell: ({ row }) => {
        const { cidade, uf } = row as ClientContext;
        return (
          <span>
            {`${cidade} - ${uf}`}
          </span>
    ...
    },
    {
      ...
      headerAlign: 'center',
      renderCell: ({ row }) => {
        const { numeroDocumento, tipoDocumento } = row as ClientContext;
        return (
          <span>
